...
namespace SteamNexus_Server.Migrations
{
    ...
    [Migration("20240524145413_GameTracking")]
    partial class GameTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SteamNexus_Server.Models.GameTracking", b =>
                {
                    b.Property<int>("GameTrackingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GameTrackingId"), 10000L);
            ...
            modelBuilder.Entity("SteamNexus_Server.Models.GameTracking", b =>
                {
                    ...
                    b.HasOne("SteamNexus_Server.Models.User", "User")
                        .WithMany("GameTrackings")
